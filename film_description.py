...
def search():
    ...
    root2 = Toplevel()
    root2.geometry('890x600+300+50')
    root2.title('Film Information')
    root2.config(bg='#B39266')
    pic = PhotoImage(file='Discriptive_background.png')
...
root = Tk()
root.geometry('1057x650+200+50')
root.title('Film Description')
